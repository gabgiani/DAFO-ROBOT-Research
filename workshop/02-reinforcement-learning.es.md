...
*[English version](02-reinforcement-learning.md)*
...
[REINFORCEMENT_LEARNING.es.md](../REINFORCEMENT_LEARNING.es.md); esta página es la experiencia
...
- **Confusión entre los paneles "Joint" y "Control".** A primera vista parecen sliders
  ...
  [REINFORCEMENT_LEARNING.es.md](../REINFORCEMENT_LEARNING.es.md#qué-significan-los-paneles-joint-y-control-del-visor).
...
La política solo camina en un piso vacío hasta ahora. La [Etapa 3](03-objetos-en-el-escenario.es.md)
