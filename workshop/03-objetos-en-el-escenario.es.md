...
*[English version](03-objetos-en-el-escenario.md)*
...
|---|---|---|
| [1. Heurístico](01-control-heuristico.es.md) | Fórmulas a mano por motor + control remoto | Cada motor funciona, pero el conjunto se cae fácil |
| [2. RL](02-reinforcement-learning.es.md) | Política ya entrenada, misma tarea | Camina largas distancias sin caerse |
| [3. RL + objetos](03-objetos-en-el-escenario.es.md) | Escenario con cajas y estante | Choca, empuja objetos, y sigue de pie |
